...
if (!class_exists('WPMUDEVSnapshot')) {
	class WPMUDEVSnapshot {
		...
		function __construct() {
			...
			$this->DEBUG									= false;
<<<<<<< HEAD
			$this->_settings['SNAPSHOT_VERSION'] 			= '2.3.3.2';
=======
			$this->_settings['SNAPSHOT_VERSION'] 			= '2.3';
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
				$snapshot_action = esc_attr($_REQUEST['snapshot-action']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
							$this->snapshot_item_run_immediate($_GET['item']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
							$return_url = add_query_arg('page', $_GET['page'], $return_url);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
										$resend_data_items = $_REQUEST['data-item'];
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
				switch($_REQUEST['snapshot-action']) {
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
						$destination_type = esc_attr($_POST['snapshot-destination-type']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
					$snapshot_item_key = $_REQUEST['item'];
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
				}
			}
...
=======
				$item_key = $_post_array['snapshot-item'];
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
				if (!isset($this->config_data['items'][$item_key]))
					die();
...
=======
				$item['name']		= 	esc_attr($_post_array['snapshot-name']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
			else
				$item['name']		= 	"";
...
=======
				$item['notes']		= 	esc_attr($_post_array['snapshot-notes']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
			else
				$item['notes']		= 	"";
...
=======
				$item['interval'] 	= 	esc_attr($_post_array['snapshot-interval']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
				$item_tmp['destination'] 			= esc_attr($_post_array['snapshot-destination']);
				$item_tmp['blog-id'] 				= intval($_post_array['snapshot-blog-id']);
				$item_tmp['timestamp'] 				= intval($_post_array['snapshot-item']);
				$item_tmp['destination-directory'] 	= esc_attr(trim($_post_array['snapshot-destination-directory']));
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
				$item['destination-directory'] 	= 	esc_attr(trim($_post_array['snapshot-destination-directory']));
				$item['destination'] 			= 	esc_attr($_post_array['snapshot-destination']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
						$item['destination-sync']		=	esc_attr($_post_array['snapshot-destination-sync']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
					}
				}
			}
...
=======
				$_oldbackupFolderFull = trailingslashit($this->_settings['backupBaseFolderFull']);
...
=======
				$segmentSize = $_REQUEST['segmentSize'];
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
=======
					$this->config_data['config']['memoryLimit'] = esc_attr($_REQUEST['memoryLimit']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
					$CONFIG_CHANGED = true;
				}
			}
...
=======
					$this->config_data['config']['zipLibrary'] = esc_attr($_REQUEST['zipLibrary']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
					$CONFIG_CHANGED = true;
				}
			}
		...
		function load_config() {
			...
			//if (!isset($this->config_data['config']['memoryLimit']))
			//	$this->config_data['config']['memoryLimit'] = ini_get('memory_limit');
												...
												if ($zip_file_info['stored_filename'] == "snapshot_manifest.txt") {
													...
													if ($extract_files) {
														...
														if (file_exists($snapshot_manifest_file)) {
															...
															$manifest_data['VERSION'] = $this->_settings['SNAPSHOT_VERSION'];

															$manifest_data['UPLOAD_PATH'] = snapshot_utility_get_blog_upload_path(intval($item['blog-id']));
			...
			switch($_REQUEST['snapshot-proc-action'])
			{
				case 'init':
					...
					if ((isset($error_array['errorStatus'])) && ($error_array['errorStatus'] == true)) {
						...
						$this->snapshot_logger->log_message("init: _SESSION". print_r($_SESSION['snapshot'], true));
				...
				case 'table':
					...
					if ((isset($error_array['errorStatus'])) && ($error_array['errorStatus'] == true)) {
						...
						$this->snapshot_logger->log_message("table: _SESSION". print_r($_SESSION['snapshot'], true));
				...
				case 'file':
					...
					if (isset($_POST['snapshot-file-data-key'])) {
						...
						if (isset($_SESSION['snapshot']['files_data']['included'][$file_data_key])) {
							...
							if ((isset($error_array['errorStatus'])) && ($error_array['errorStatus'] == true)) {
								...
								$this->snapshot_logger->log_message("file: _SESSION". print_r($_SESSION['snapshot'], true));
				...
				case 'finish':
					...
					if ((isset($error_array['errorStatus'])) && ($error_array['errorStatus'] == true)) {
						...
						$this->snapshot_logger->log_message("finish: _SESSION:". print_r($_SESSION['snapshot'], true));
...
//			$this->snapshot_item_run_immediate($item_key);
		...
		function snapshot_ajax_backup_init($item, $_post_array) {
			...
			$_SESSION['snapshot']['backupItemFolder'] = $sessionItemBackupFolder;

			if (isset($_SESSION['snapshot']['table_data']))
				unset($_SESSION['snapshot']['table_data']);
			...
			if ((isset($tables_sections)) && (count($tables_sections))) {
				...
				if ((isset($tables_sections)) && (count($tables_sections))) {
					$_SESSION['snapshot']['tables_sections'] 	= $tables_sections;
				} else {
					$_SESSION['snapshot']['tables_sections']	= array();
				}

				if (isset($error_status['table_data'])) {
					$_SESSION['snapshot']['table_data'] 			= $error_status['table_data'];
				}
			}
			...
			if ($item['destination-sync'] == "archive") {
				...
				if ((isset($error_status['files_data']['included'])) && (count($error_status['files_data']['included']))) {
					...
					//echo "files_data<pre>"; print_r($error_status['files_data']['included']); echo "</pre>";
					//die();
					$_SESSION['snapshot']['files_data'] 			= $error_status['files_data'];

					$error_status['files_data'] = array_keys($error_status['files_data']['included']);
				}
			} else {
				$_SESSION['snapshot']['files_data'] = '';
				$error_status['files_data'] = '';
			}
			$_SESSION['snapshot']['snapshot_time_start'] 	= time();
		...
		function snapshot_ajax_backup_table($item, $_post_array) {
			...
			if ((isset($_SESSION['snapshot']['table_data'])) && (isset($_SESSION['snapshot']['table_data'][$table_data_idx]))) {
				$table_data = $_SESSION['snapshot']['table_data'][$table_data_idx];
			}
			...
			if (isset($_SESSION['snapshot']['backupItemFolder'])) {
<<<<<<< HEAD
				$backupTable = sanitize_text_field($table_data['table_name']);
=======
				$backupTable = esc_attr($table_data['table_name']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
				$backupFile = trailingslashit($_SESSION['snapshot']['backupItemFolder']) . $backupTable .".sql";
				...
				if ($fp) {
					...
					if (intval($table_data['segment_idx']) == intval($table_data['segment_total'])) {
						// If we are at the enf ot the table's segments we now just pass a large number for the table end.
						...
						$number_rows_segment = $backup_db->backup_table($backupTable, $table_data['rows_start'],
							$table_data['rows_total'] * 3, $table_data['rows_total'] * 3);
					} else {
					...
					$_SESSION['snapshot']['table_data'][$table_data_idx] = $table_data;
					...
					if (intval($table_data['segment_idx']) == intval($table_data['segment_total'])) {
						...
						$backupZipFile = trailingslashit($_SESSION['snapshot']['backupItemFolder']) .'snapshot-backup.zip';

						if ($this->config_data['config']['zipLibrary'] == "PclZip") {
							$zipArchive = new PclZip($backupZipFile);
							try {
								$zip_add_ret = $zipArchive->add($archiveFiles,
													PCLZIP_OPT_REMOVE_PATH, $_SESSION['snapshot']['backupItemFolder'],
													PCLZIP_OPT_TEMP_FILE_THRESHOLD, 10,
...
<<<<<<< HEAD
									...
									$zipArchive->addFile($file, str_replace($_SESSION['snapshot']['backupItemFolder'] .'/', '', $file));
=======
									$zipArchive->addFile($file, str_replace($_SESSION['snapshot']['backupItemFolder'], '', $file));
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
								}
...
=======
				$file_data_key = esc_attr($_post_array['snapshot-file-data-key']);
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
				if (isset($_SESSION['snapshot']['files_data']['included'][$file_data_key])) {
					...
					if ($this->config_data['config']['zipLibrary'] == "PclZip") {
						...
						try {
							...
							$zip_add_ret = $zipArchive->add($_SESSION['snapshot']['files_data']['included'][$file_data_key],
						...
						if ($zipArchive) {
							...
							$fileCount = 0;
							foreach($_SESSION['snapshot']['files_data']['included'][$file_data_key] as $file) {
<<<<<<< HEAD
								$file = str_replace('\\', '/', $file);
=======
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
					...
					foreach($_SESSION['snapshot']['files_data']['included'][$file_data_key] as $idx => $filename) {
...
=======
					$data_item_key = $_post_array['snapshot-data-item'];
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
				else
					$data_item_key = time();
				...
				if (isset($_SESSION['snapshot']['tables_sections'])) {
					$data_item['tables-sections']		=	$_SESSION['snapshot']['tables_sections'];
					$item['tables-sections'] 			=	$_SESSION['snapshot']['tables_sections'];
				}
				...
				if (isset($_SESSION['snapshot']['files_data']['included'])) {

					$session_files_data = array();
					foreach($_SESSION['snapshot']['files_data']['included'] as $files_section => $files_set) {
				...
				if (isset($_SESSION['snapshot']['snapshot_time_start'])) {
					$data_item['time-start']			= $_SESSION['snapshot']['snapshot_time_start'];
					$data_item['time-end']				= time();

					unset($_SESSION['snapshot']['snapshot_time_start']);
				}

				$manifest_array = array();
				$manifest_array['BLOG-ID'] = intval($_post_array['snapshot-blog-id']);
				...
				$manifest_array['VERSION'] = $this->_settings['SNAPSHOT_VERSION'];
				$manifest_array['DB_NAME'] = snapshot_utility_get_db_name();
				$manifest_array['BASE_PREFIX'] = $wpdb->base_prefix;
				$manifest_array['PREFIX'] = $wpdb->get_blog_prefix( intval($_post_array['snapshot-blog-id']) );
				$manifest_array['SEGMENT_SIZE'] = intval($this->config_data['config']['segmentSize']);
				$manifest_array['UPLOAD_PATH'] = snapshot_utility_get_blog_upload_path(intval($_post_array['snapshot-blog-id']));
				$manifest_array['DB_NAME'] = snapshot_utility_get_db_name();
				...
				if (is_multisite())
					$home = get_blog_option( intval($_post_array['snapshot-blog-id']), 'home' );
				else
					$home = get_option( 'home' );
				if ($home) {
					$manifest_array['HOME'] = $home;
				}

				if (is_multisite())
					$siteurl = get_blog_option( intval($_post_array['snapshot-blog-id']), 'siteurl' );
				else
					$siteurl = get_option( 'siteurl' );

				if ($siteurl) {
					$manifest_array['SITEURL'] = $siteurl;
				}

				if (isset($_SESSION['snapshot']['tables_sections'])) {
					//fwrite($fp, "TABLES:". serialize($_SESSION['snapshot']['tables_sections']) ."\r\n");
					$manifest_array['TABLES'] = $_SESSION['snapshot']['tables_sections'];
				}

				if (isset($_SESSION['snapshot']['table_data'])) {
					//fwrite($fp, "TABLES-DATA:". serialize($_SESSION['snapshot']['table_data']) ."\r\n");
					$manifest_array['TABLES-DATA'] = $_SESSION['snapshot']['table_data'];
				}
				...
				if (isset($session_files_data)) {
					...
					//fwrite($fp, "FILES-DATA:". serialize($_SESSION['snapshot']['files_data']) ."\r\n");
				...
				if (file_exists($backupZipFile)) {
					...
					$manifestFile = trailingslashit($_SESSION['snapshot']['backupItemFolder']) . 'snapshot_manifest.txt';
...
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
					...
					if ((empty($data_item['destination'])) || ($data_item['destination'] == "local")) {
						$backupZipFolder = $this->snapshot_get_item_destination_path($item, $data_item);
					...
					rename($backupZipFile, $backupZipFileFinal);
				...
				if ((isset($_SESSION['snapshot']['tables_sections']))
				 && (isset($_SESSION['snapshot']['table_data'])) && (count($_SESSION['snapshot']['table_data']))) {
					if (!isset($this->config_data['config']['tables_last'][$_post_array['snapshot-blog-id']]))
						$this->config_data['config']['tables_last'][$item['blog-id']] = array();

					$this->config_data['config']['tables_last'][$item['blog-id']] = $_SESSION['snapshot']['tables_sections'];
				}
		...
		function snapshot_ajax_show_blog_tables() {
			...
			if ( (isset($_POST['snapshot_blog_id_search'])) && (!empty($_POST['snapshot_blog_id_search'])) ) {
				$snapshot_blog_id_search = $_POST['snapshot_blog_id_search'];
...
<<<<<<< HEAD
					$sql_str = $wpdb->prepare("SELECT blog_id FROM $wpdb->blogs WHERE domain = %s LIMIT 1", $snapshot_blog_id_search);
=======
					$sql_str = "SELECT blog_id FROM $wpdb->blogs WHERE domain = '". $snapshot_blog_id_search ."' LIMIT 1";
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
...
>>>>>>> 2c051ad76c4e79b45eb2ffa1c0d1b03b8e2c09b9
		...
		function snapshot_ajax_restore_init($item) {
			...
			if (!file_exists($restoreFile)) {
				$error_status['errorStatus'] 	= true;
				$error_status['errorText'] 		= "<p>". __("ERROR: The Snapshot file not found:",
			...
			$extract_files = $zipArchive->extract($sessionRestoreFolder);
			if ($extract_files) {

				$_SESSION['snapshot']['restoreFolder'] = $sessionRestoreFolder;
				//$_SESSION['snapshot']['restoreFiles'] = $extract_files;
			}
			...
			if (isset($error_status['MANIFEST']['VERSION'])) {
				if (($error_status['MANIFEST']['VERSION'] == "1.0") && (!isset($error_status['MANIFEST']['TABLES-DATA']))) {
			...
			if ((isset($_POST['snapshot-tables-option'])) && ($_POST['snapshot-tables-option'] != "all")) {
				...
				if (isset($error_status['MANIFEST']['TABLES'])) {
			...
			if ((isset($error_status['MANIFEST']['TABLES-DATA'])) && (count($error_status['MANIFEST']['TABLES-DATA']))) {
				...
				foreach($error_status['MANIFEST']['TABLES-DATA'] as $table_set) {
					//echo "table_set<pre>"; print_r($table_set); echo "</pre>";
					if (!isset($table_set['table_name'])) continue;

					if (array_search($table_set['table_name'], $error_status['MANIFEST']['TABLES']) !== false) {
			...
			if (isset($_POST['snapshot-files-option'])) {
				...
				if (isset($error_status['MANIFEST']['ITEM']['data'])) {
					...
					if (isset($data_item['files-sections'])) {
						$error_status['MANIFEST']['FILES-DATA'] = $data_item['files-sections'];
					}
				}
			}
			...
			$_SESSION['snapshot']['MANIFEST'] = $error_status['MANIFEST'];
			return $error_status;
		}
		...
		function snapshot_ajax_restore_table($item) {
			...
			if ((is_multisite()) && ($current_blog->blog_id != $item['blog-id'])){
				$wpdb->set_blog_id($item['blog-id']);
			}
			...
			if ((isset($_POST['snapshot_table'])) && (isset($_POST['table_data']))) {
				...
				//echo "table_data<pre>"; print_r($_POST['table_data']); echo "</pre>";
				$table_data = $_POST['table_data'];
				$restoreFile = trailingslashit($_SESSION['snapshot']['restoreFolder']) . esc_attr($_POST['snapshot_table']) . ".sql";
				if (file_exists($restoreFile)) {
		...
		function snapshot_ajax_restore_file($item) {
			...
			//echo "_POST<pre>"; print_r($_POST); echo "</pre>";
			//echo "_SESSION['snapshot']<pre>"; print_r($_SESSION['snapshot']); echo "</pre>";
			//die();

			if (!isset($_SESSION['snapshot']['MANIFEST']['FILES-DATA'])) {
				$error_status['errorStatus'] 	= true;
			...
			if (!isset($_SESSION['snapshot']['MANIFEST']['FILES-DATA'][$file_data_idx])) {
				$error_status['errorStatus'] 	= true;
			...
			$this->snapshot_logger->log_message('restore: file-section: '. $_SESSION['snapshot']['MANIFEST']['FILES-DATA'][$file_data_idx] .')');
			$restoreFilesBase = trailingslashit($_SESSION['snapshot']['restoreFolder']) .'www/';
			$restoreFilesSet = array();
			switch($_SESSION['snapshot']['MANIFEST']['FILES-DATA'][$file_data_idx]) {
				case 'themes':
					$restoreFilesPath = $_SESSION['snapshot']['restoreFolder'] . "www/wp-content/themes";
				...
				case 'media':
					$restoreFilesPath = $restoreFilesBase . "/". $_SESSION['snapshot']['MANIFEST']['UPLOAD_PATH'];
					//echo "restoreFilesPath=[". $restoreFilesPath ."]<br />";
					if (is_dir($restoreFilesPath)) {
						$restoreFilesSet = snapshot_utility_scandir($restoreFilesPath);
					}
			...
			foreach($restoreFilesSet as $restoreFileFull) {
				...
				//echo "restoreFileFull=[". $restoreFileFull ."]<br />";
				//echo "destinationFileFull=[". $destinationFileFull ."]<br />";
				//continue;
			...
			$error_status['file_data'] = $_SESSION['snapshot']['MANIFEST']['FILES-DATA'][$file_data_idx];
		...
		function snapshot_ajax_restore_finish($item) {
			...
			if ($dh = opendir($_SESSION['snapshot']['restoreFolder'])) {
				while (($file = readdir($dh)) !== false) {
					if (($file == '.') || ($file == '..'))
						continue;

					snapshot_utility_recursive_rmdir($_SESSION['snapshot']['restoreFolder'] . $file);
				}
				closedir($dh);
			}
			$error_status = array();
			 ...
			 || ($item['tables-option'] == "all") || ($item['tables-option'] == "selected") ) {
				...
				if ($_post_array['snapshot-tables-option'] == "none") {
					...
					if (isset($item['tables-sections'])) {
						$_SESSION['snapshot']['tables-sections'] = $item['tables-sections'];
				...
				if ((isset($error_array['table_data'])) && (count($error_array['table_data']))) {
					...
					foreach($error_array['table_data'] as $idx => $table_item) {
						...
						if ((isset($error_array['errorStatus'])) && ($error_array['errorStatus'] == true)) {
							...
							$this->snapshot_logger->log_message("table: ". $table_item['table_name'] .": _SESSION". print_r($_SESSION['snapshot'], true));
...
//				die();
		...
		function snapshot_get_item_destination_path($item=array(), $data_item=array(), $create_folder=true) {
			...
			if (empty($data_item['destination'])) {
			...
			// the site root path.
			if ((empty($data_item['destination'])) && (!empty($backupFolder))) {
		...
		function snapshot_gather_item_files($item) {
			...
			if ((is_multisite()) && (is_main_site())) {
				...
				$sub_blog_id = $blog_id+1;
				$sub_site_upload_path = snapshot_utility_get_blog_upload_path( $sub_blog_id );

				if ((!empty($sub_site_upload_path))
				 && ($sub_site_upload_path !== $main_site_upload_path)
